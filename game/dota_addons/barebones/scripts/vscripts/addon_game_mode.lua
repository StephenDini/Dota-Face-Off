...
--[[
  ...
  See GameMode:PostLoadPrecache() in gamemode.lua for more information
	...
	PrecacheResource("particle_folder", "particles/basic_ambient", context)
	...
	PrecacheUnitByNameSync("npc_dota_hero_an cient_apparition", context)
	PrecacheUnitByNameSync("npc_dota_hero_enigma", context)

	PrecacheUnitByNameSync("npc_dota_creep_badguys_ranged", context)
	PrecacheUnitByNameSync("npc_dota_creep_badguys_ranged_upgraded", context)
	PrecacheUnitByNameSync("npc_dota_creep_badguys_ranged_upgraded_mega", context)
	PrecacheUnitByNameSync("npc_dota_creep_goodguys_ranged", context)
	PrecacheUnitByNameSync("npc_dota_creep_goodguys_ranged_upgraded", context)
	PrecacheUnitByNameSync("npc_dota_creep_goodguys_ranged_upgraded_mega", context)
	PrecacheUnitByNameSync("npc_dota_creep_badguys_melee", context)
	PrecacheUnitByNameSync("npc_dota_creep_badguys_melee_upgraded", context)
	PrecacheUnitByNameSync("npc_dota_creep_badguys_melee_upgraded_mega", context)
	PrecacheUnitByNameSync("npc_dota_creep_goodguys_melee", context)
	PrecacheUnitByNameSync("npc_dota_creep_goodguys_melee_upgraded", context)
	PrecacheUnitByNameSync("npc_dota_creep_goodguys_melee_upgraded_mega", context)
