...
-- this will need to be eddited later when you work on the re randoming. 
	elseif new_state == DOTA_GAMERULES_STATE_HERO_SELECTION then
		...
		-- time was set to .1 here so that the player has no time to chose and will auto select for the player. original was: HERO_SELECTION_TIME+STRATEGY_TIME-1
